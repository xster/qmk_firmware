...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ortho_5x15(
    ...
    KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_GRV, KC_BSLS, LCTL(KC_GRV), KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC,
  ...
  [1] = LAYOUT_ortho_5x15(
    ...
    KC_CAPSLOCK, KC_NO, LCTL(LSFT(KC_TAB)), LCTL(KC_TAB), KC_NO, KC_NO, KC_P1, KC_P2, KC_P3, KC_PAST, KC_PSLS, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU,
    KC_TRNS, KC_NO, LCMD(KC_LEFT), LCMD(KC_RIGHT), KC_NO, KC_BSPC, KC_P0, KC_SLSH, KC_PDOT, KC_PENT, KC_NO, KC_NO, KC_MRWD, KC_MPLY, KC_MFFD,
    TG(1), KC_TRNS, KC_TRNS, KC_TRNS, MO(2), KC_NO, KC_NO, KC_NO, KC_ASTR, KC_PENT, KC_PENT, MO(1), KC_TRNS, KC_TRNS, TG(1)),
  [2] = LAYOUT_ortho_5x15(
    RESET, LALT(LGUI(KC_SLEP)), KC_WAKE, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
