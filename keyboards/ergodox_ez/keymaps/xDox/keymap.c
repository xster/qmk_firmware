...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, LCTL(KC_K),     LGUI(KC_LEFT),  LGUI(KC_RIGHT), LCTL(LSFT(KC_K)), KC_TILD,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_BSPACE,      KC_1,           KC_2,           KC_3,           KC_KP_ASTERISK, KC_MEDIA_PLAY_PAUSE,
    KC_TRANSPARENT, KC_MS_WH_LEFT,  KC_MS_WH_UP,    KC_MS_WH_DOWN,  KC_MS_WH_RIGHT,                                                                                                 KC_TRANSPARENT, KC_KP_0,        RALT_T(KC_KP_DOT),KC_MPRV,      KC_MNXT,
